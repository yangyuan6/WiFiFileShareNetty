...
public class NioGetFileListHandler extends ChannelInboundHandlerAdapter {
    ...
    public NioGetFileListHandler(ArrayList<ServiceFileInfo> fileInfos, Handler uiHandler){
